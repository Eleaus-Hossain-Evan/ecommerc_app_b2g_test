...
class Data {
  ...
  factory Data.fromJson(Map<String?, dynamic> json) => Data(
        ...
        productSection: List<ProductSection>.from(
            json["productSection"].map((x) => ProductSection.fromJson(x))),
      );
}
...
class Info {
  ...
  factory Info.fromJson(Map<String?, dynamic> json) => Info(
        ...
        sliders: List<Category>.from(
            json["sliders"].map((x) => Category.fromJson(x))),
        footerLogo: json["footerLogo"],
        topLogo: json["topLogo"],
        termsPrivacyAbout:
            TermsPrivacyAbout.fromJson(json["termsPrivacyAbout"]),
...
class TermsPrivacyAbout {
  ...
  factory TermsPrivacyAbout.fromJson(Map<String?, dynamic> json) =>
      TermsPrivacyAbout(
